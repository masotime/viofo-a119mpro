...
struct ContentView: View {
    ...
    @State private var fileSortOrder = [
        KeyPathComparator(\ViofoFile.time, order: .reverse)
    ]
    ...
    private var sortedFiles: [ViofoFile] {
        model.files.sorted(using: fileSortOrder)
    }
    ...
    private var filesTable: some View {
        Table(sortedFiles, selection: $selectedFileID, sortOrder: $fileSortOrder) {
            ...
            TableColumn("Folder", value: \.folderLabel) { file in
